function [P,MSEAB,F3] = RMAOV2_mod_oded(X,alpha,showtable)
...
if showtable
 ...
 fprintf('The percentage of the variability in the DV associated with the IV1*IV2 (eta squared) is% 3.2f\n', eta212);
  disp('(After the effects of individual differences have been removed).');disp('  ');
end
