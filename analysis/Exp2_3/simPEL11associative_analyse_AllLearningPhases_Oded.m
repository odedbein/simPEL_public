function [data_learning, simPEL11_All_subs_learning_byItemAllReps,simPEL11_All_subs_learning, simPEL11_All_subs_learning_averages,simPEL11_All_subs_learning_byItemAllRepsCollapsVnv]=simPEL11associative_analyse_AllLearningPhases_Oded() %subjects_numbers,subjects_names
    ...
    for bb = 1:numel(ABmem_name)
        ...
        for cond=1:num_triads_conds
            ...
            for loc=curr_loc %for all locs
                ...
                % participant response. log RT is just for stats etc. also
                % ended up not using log RT at all.
