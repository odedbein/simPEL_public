...
%% no figure in the paper - but tons of plots here if anyone is interested...
...
plotSubj=0;
good_subj=1:length(subjects_numbers);% 1:length(subjects_numbers);
...
[h,p,ci,stats]=ttest(curr_data(:,1),curr_data(:,2))
display(sprintf('v/nv foils t-tests \n'));
[h,p,ci,stats]=ttest(curr_data(:,3),curr_data(:,4))
