function [simPEL9_All_subs_recognition, simPEL9_All_subs_explicit]=simPEL9_analyse_recExplicit_Oded() 
%% I had a bug in my code that runs the study! until participant number 15 -
%%all participants were instructed to press J for old, K for similar and L
%%for new. But, the mapping of the response was correct for ss of even number and incorrect for participants with odd numbers.
%%thst means that the number under response is good, but the accuracy set
%%up is worng. I corrected it after participant 15. That means that the
%%accuracy for participants: 1 5 7 13 15. I corrected their matlab fiels to
%%have the correct response type and accuracy, but their text logfiles I
%%kept original. I did so by uploading the relevant matlab structure, then
%%running the code in 
%%it was like this (in the code that runs the task):
...
results_rtable_fname='simPEL9_recognition_trials_Bconf.txt';
...
%set up a figure for marking RT outliers:
f = figure;
set(f,'name','simPEL9','numbertitle','off');

%set up data structures:
simPEL9_All_subs_recognition={};
simPEL9_All_subs_explicit={};
...
for subj=1:numel(subjects_numbers)
    ...
    simPEL9_All_subs_recognition.All.num_items(subj,:)=curr_sub_data.All.num_items;
    simPEL9_All_subs_recognition.All.num_itemsRT(subj,:)=curr_sub_data.All.num_itemsRT;
    simPEL9_All_subs_recognition.All.total_responses(subj,:)=curr_sub_data.All.total_responses;
    simPEL9_All_subs_recognition.All.accuracy_num(subj,:)=curr_sub_data.All.accuracy_num;
    simPEL9_All_subs_recognition.All.accuracy_rates(subj,:)=curr_sub_data.All.accuracy_rates;
    simPEL9_All_subs_recognition.All.response_typePerCond(subj,:)=curr_sub_data.All.response_typePerCond;
    simPEL9_All_subs_recognition.All.response_OldOrSim(subj,:)=curr_sub_data.All.response_OldOrSim;
    simPEL9_All_subs_recognition.All.RT(subj,:)=curr_sub_data.All.RT;
    simPEL9_All_subs_recognition.All.logRT(subj,:)=curr_sub_data.All.logRT;

    simPEL9_All_subs_recognition.All.Bmem.num_items(subj,:)=curr_sub_data.All.Bmem.num_items;
    simPEL9_All_subs_recognition.All.Bmem.response_typePerCondNum(subj,:)=curr_sub_data.All.Bmem.response_typePerCondNum;
    simPEL9_All_subs_recognition.All.Bmem.response_typePerCond(subj,:)=curr_sub_data.All.Bmem.response_typePerCond;
    simPEL9_All_subs_recognition.All.Bmem.RT(subj,:)=curr_sub_data.All.Bmem.RT;
    simPEL9_All_subs_recognition.All.Bmem.num_itemsRT(subj,:)=curr_sub_data.All.Bmem.num_itemsRT;
    ...
    simPEL9_All_subs_explicit.Part1.AvConfRates(subj,:)=curr_sub_conf;
    simPEL9_All_subs_explicit.Part1.AvConfRatesSD(subj,:)=curr_sub_confSD;
    simPEL9_All_subs_explicit.Part1.OldNew(subj,:)=curr_sub_OldNew;
    simPEL9_All_subs_explicit.Part1.CountEachRating(subj,:)=curr_sub_CountEachRating;
    
    simPEL9_All_subs_explicit.Part1.AvConfRatesAvDist(subj,:)=curr_sub_confAvDist;
    simPEL9_All_subs_explicit.Part1.AvConfRatesSDAvDist(subj,:)=curr_sub_confSDAvDist;
    simPEL9_All_subs_explicit.Part1.OldNewAvDist(subj,:)=curr_sub_OldNewAvDist;
    simPEL9_All_subs_explicit.Part1.CountEachRatingAvDist(subj,:)=curr_sub_CountEachRatingAvDist;
    ExpPart=2;
    [curr_sub_conf, curr_sub_confSD, curr_sub_OldNew, curr_sub_CountEachRating, ...
     curr_sub_confAvDist, curr_sub_confSDAvDist, curr_sub_OldNewAvDist, curr_sub_CountEachRatingAvDist]=analyze_explicit_single_sub(curr_sub,subjects_names{subj},project_dir,ExpPart);
    simPEL9_All_subs_explicit.Part2.AvConfRates(subj,:)=curr_sub_conf;
    simPEL9_All_subs_explicit.Part2.AvConfRatesSD(subj,:)=curr_sub_confSD;
    simPEL9_All_subs_explicit.Part2.OldNew(subj,:)=curr_sub_OldNew;
    simPEL9_All_subs_explicit.Part2.CountEachRating(subj,:)=curr_sub_CountEachRating;
    
    simPEL9_All_subs_explicit.Part2.AvConfRatesAvDist(subj,:)=curr_sub_confAvDist;
    simPEL9_All_subs_explicit.Part2.AvConfRatesSDAvDist(subj,:)=curr_sub_confSDAvDist;
    simPEL9_All_subs_explicit.Part2.OldNewAvDist(subj,:)=curr_sub_OldNewAvDist;
    simPEL9_All_subs_explicit.Part2.CountEachRatingAvDist(subj,:)=curr_sub_CountEachRatingAvDist;
end
