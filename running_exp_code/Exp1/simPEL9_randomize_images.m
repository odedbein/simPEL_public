function simPEL9_randomize_images(subj_num,subj_id)
...
runs_violation=4; %divide to 4 scans, each will have 9 pairs in each condition, reminder and v/nv
...
nRuns=4; %just to have the cond allocation correct - in realirty we divide to half
